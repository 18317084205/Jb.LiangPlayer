...
import com.ljb.jbplayer.module.skinloader.calback.ISkinLoader;
...
public class SkinManager implements ISkinLoader {
    ...
    public Drawable getDrawable(int resId) {
        ...
        try {
            Logger.i("SkinManager getDrawable", "SDK_INT = " + android.os.Build.VERSION.SDK_INT);
