...
import com.ljb.jbplayer.module.skinloader.attr.AttrFactory;
...
public class SkinInflaterFactory implements LayoutInflaterFactory {
    ...
    private View createView(Context context, String name, AttributeSet attrs) {
        ...
        try {
            ...
            Logger.i(TAG, "about to create " + name);

        } catch (Exception e) {
            Logger.e(TAG, "error while create 【" + name + "】 : " + e.getMessage());
            view = null;
        }
        return view;
    }
        ...
        for (int i = 0; i < attrs.getAttributeCount(); i++) {//遍历当前View的属性
            ...
            if (attrValue.startsWith("@")) {//也就是引用类型，形如@color/red
                try {
                    ...
                    Logger.i("parseSkinAttr", "view:" + view.getClass().getSimpleName());
                    Logger.i("parseSkinAttr", "attrName:" + attrName + " | attrValue:" + attrValue);
                    Logger.i("parseSkinAttr", "id:" + id);
                    Logger.i("parseSkinAttr", "entryName:" + entryName);
                    Logger.i("parseSkinAttr", "typeName:" + typeName);
                    if (mSkinAttr != null) {
